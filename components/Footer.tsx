      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[1.3fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="mb-4 max-w-md text-sm leading-relaxed text-white/64">
          ...
          {FOOTER_GROUPS.map((group) => (
            <div key={group.title}>
              <h3 className="mono-label mb-4 text-[11px] font-bold uppercase tracking-[0.24em] text-white/58">
                {group.title}
              </h3>
